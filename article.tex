...
As may be observed after the Table analysis, the experiments will be based on data sets with relatively small spatiality (up to \oldstylenums{13} dimensions), with imbalance ratio from \oldstylenums9 to even \oldstylenums{40}.
